...
<head>
    ...
    <title><?php echo e($exam->title); ?> — Composition</title>
    <style>
...
<body>
    ...
    <header class="exam-header">
        <div class="header-left">
            ...
            <span class="exam-title-header"><?php echo e($exam->title); ?></span>
        </div>
        ...
        <div class="header-center">
            ...
            <div class="tab-switch-indicator" id="tabSwitchIndicator">
                <span>🔄</span>
                <span id="tabSwitchText">Sorties : 0/<?php echo e($exam->settings['max_tab_switches'] ?? 2); ?></span>
            </div>
        </div>
    ...
    (function() {
        ...
        // ═══════════ CONFIG ═══════════
        const EXAM_TOKEN = <?php echo json_encode($exam->token, 15, 512) ?>;
        const SUBMISSION_ID = <?php echo e($submission->id); ?>;
        const REMAINING_SECONDS = <?php echo e($remaining); ?>;
        const MAX_TAB_SWITCHES = <?php echo e($exam->settings['max_tab_switches'] ?? 2); ?>;
        const STUDENT_NAME = <?php echo json_encode($submission->student_name, 15, 512) ?>;
        const STUDENT_MATRICULE = <?php echo json_encode($submission->student_matricule, 15, 512) ?>;
...
<?php /**PATH C:\EDUASSIST\backend\resources\views/exam/exam-compose.blade.php ENDPATH**/ ?>